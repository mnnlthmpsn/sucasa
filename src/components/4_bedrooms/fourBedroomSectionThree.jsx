export const FourBedRoomSectionThree = () => {
    return (
        <div className="snap-start h-auto w-full py-24 bg-black">
            <div className="grid lg:grid-cols-2 container items-center text-white">
                ...
                <div className="flex flex-col items-start space-y-4 justify-center p-14">
                    ...
                    <p>A generous amount of space and all rooms en-suite allow you to decorate your home to suit your style</p>
                </div>
                <div className="flex flex-col items-start space-y-4 justify-center p-14">
